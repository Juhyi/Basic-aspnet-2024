...
namespace MyPortfolio.Controllers
{
    public class BoardController : Controller
    {
        ...
        // GET: Boards
        // FromSql()로 작업시는 비동기 async, Task<>를 걷어내야 함.
        ...
        {
            var totalCount  = _context.Board.FromSqlRaw<Board>($"SELECT * FROM Board WHERE Title LIKE '%{search}%'").Count();  // 총 게시글 수
            ...
            var startPage = ((page - 1) / countPage) * countPage + 1;   // 1~10페이지, 11~20 페이지 식으로
            ...
            // ViewData, ViewBag 변수 ... (뷰 cshtml에서 사용할 변수)
